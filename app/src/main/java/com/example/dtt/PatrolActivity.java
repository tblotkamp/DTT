...
public class PatrolActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    // Ključevi za spremanje stanja aktivnosti.
    ...
    public void onRequestPermissionsResult(int requestCode,
        ...
        switch (requestCode) {
            case PERMISSIONS_REQUEST_ACCESS_FINE_LOCATION: {
                // Ako se zahtjev poništi, niz ostaje prazan.
    ...
    public void onMapReady(GoogleMap map) {
        ...
        Cursor c = db.query("patrols", new String[] {"patrollatitude",
                        "patrollongitude", "patroltime"}, null, null,
                null, null, null);
